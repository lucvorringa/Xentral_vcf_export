...
class vcf {
  ...
  function vcfList()
  {
        ...
        readfile("/opt/xentral-userdata/adressen.vcf"); //hier muss der Userdata Ordner hinterlegt werden
...
class vcardexp
        /* Bibliothek zur Genegierung von digitalen Visitenkarten */
        {
                ...
                {
                        $vcardfile = '/opt/xentral-userdata/adressen.vcf';
                        $handle = fopen($vcardfile, 'a') or die('Cannot open file:  '.$vcardfile);
